# SysNex Systems Corporate Design Style Guide
...
**SysNex Systems** specializes in Model-Based Systems Engineering (MBSE) with a focus on SysML v2, functional safety, and Git-based workflows. Our brand identity reflects precision, innovation, and technical excellence.
...
- **RGB**: `rgb(0, 180, 216)`
- **HSL**: `hsl(193, 100%, 42%)`
- **Usage**: Primary brand color - used for headings, navigation links, primary UI elements, and development/design phases in diagrams. Matches the cyan color in the logo.
- **CSS Variable**: `var(--turquoise)`
- **Logo Usage**: Left curve/primary accent in logo

#### Secondary Brand Color (Amber/Yellow)
- **Hex**: `#FBBF24`
- **RGB**: `rgb(251, 191, 36)`
- **HSL**: `hsl(43, 96%, 56%)`
- **Usage**: Secondary brand color - used for warnings, highlights, accents, call-to-action buttons, card titles, and verification/validation phases in diagrams. Matches the amber/yellow accent in the logo.
- **CSS Variable**: `var(--amber)`
- **Logo Usage**: Center accent in logo

#### Secondary Brand Color (Aubergine/Magenta) - Legacy/Alternative
- **Hex**: `#5c2a64ff`
- **RGB**: `rgb(92, 42, 100)`
- **Usage**: Alternative secondary color - used for hover states and special accents. Not currently in the primary logo but may be used in diagrams and special contexts.
- **CSS Variable**: `var(--aubergine)`

#### Tertiary Brand Color (Navy Blue)
- **Hex**: `#0F2747`
- **RGB**: `rgb(15, 39, 71)`
- **HSL**: `hsl(215, 65%, 17%)`
- **Usage**: Tertiary brand color - used for backgrounds, panels, and structural elements. Matches the navy blue base in the logo.
- **CSS Variable**: `var(--navy)`
- **Logo Usage**: Base/background element in logo

#### Tertiary Highlight Color (Coral Orange) - Legacy/Alternative
- **Hex**: `#ff6600`
- **RGB**: `rgb(255, 102, 0)`
- **Usage**: Alternative tertiary highlight color - used for special accents and emphasis where additional visual variety is needed. Not in primary logo.
...
The primary logo (`logo_new.svg`) uses three colors that form the foundation of the brand:

1. **Primary Cyan (`#00B4D8`)**: Left curve/primary accent
2. **Amber/Yellow (`#FBBF24`)**: Center accent
3. **Navy Blue (`#0F2747`)**: Base/background element

These colors are used consistently across all brand materials including the VS Code themes.

### Color Usage Guidelines

- **Primary color (`#00B4D8`)**: Use for main navigation, headings (h1, h2), primary links, and development/design elements
- **Secondary color (`#FBBF24`)**: Use for warnings, highlights, interactive accents, card titles (h3), and verification/validation elements
- **Tertiary color (`#0F2747`)**: Use for backgrounds, panels, and structural UI elements
- **Alternative colors**: `#C80064` (aubergine) and `#ff6600` (coral) may be used for special contexts or legacy compatibility
...
- **Subtle backgrounds**: `rgba(0, 180, 216, 0.03)` to `rgba(0, 180, 216, 0.06)` (primary cyan)
- **Borders**: `rgba(0, 180, 216, 0.1)` to `rgba(0, 180, 216, 0.3)` (primary cyan)
- **Hover effects**: `rgba(0, 180, 216, 0.4)` to `rgba(0, 180, 216, 0.6)` (primary cyan)
- **Shadows/Glows**: `rgba(0, 180, 216, 0.15)` to `rgba(0, 180, 216, 0.3)` (primary cyan)
- **Amber highlights**: `rgba(251, 191, 36, 0.3)` to `rgba(251, 191, 36, 0.5)` (secondary amber)
...
h3 { color: var(--amber); font-weight: 600; }
...
- **Colors**: Primary logo uses `#00B4D8` (cyan), `#FBBF24` (amber), and `#0F2747` (navy blue)
- **Hover Effect**: Scale to 1.15x with 5deg rotation, enhanced glow
- **Filter**: `drop-shadow(0 0 8px rgba(0, 180, 216, 0.3))` (using primary cyan)
...
- **Colors**:
  - Development/Design: `#00B4D8` (cyan blue - primary, from logo)
  - Verification/Validation: `#FBBF24` (amber/yellow - secondary, from logo)
  - Highlights/Accents: `#0F2747` (navy blue - tertiary, from logo)
  - Alternative: `#C80064` (aubergine/magenta) or `#ff6600` (coral orange) for special contexts
  - Background: `#0d0d0d`
- **Font**: Lexend Exa
...
- ✅ **Do**: Use consistent color palette (`#00B4D8`, `#FBBF24`, `#0F2747`, `#0d0d0d`) matching the logo
- ✅ **Do**: Use Lexend Exa font family
- ✅ **Do**: Maintain viewBox proportions
- ✅ **Do**: Include proper accessibility attributes
- ✅ **Do**: Reference logo colors for brand consistency
...
```css
:root {
  --turquoise: #00B4D8;  /* Primary - cyan blue from logo (left curve) */
  --amber: #FBBF24;      /* Secondary - amber/yellow from logo (center accent) */
  --navy: #0F2747;       /* Tertiary - navy blue from logo (base element) */
  --aubergine: #C80064;  /* Alternative - aubergine/magenta for special contexts */
  --coral: #ff6600;      /* Alternative - coral orange for highlights */
  --dark-bg: #0d0d0d;
  --light-text: #e6fdf8;
}
```
...
- **v1.2** (Current): Updated to match actual logo colors (`logo_new.svg`) - Primary: `#00B4D8` (cyan), Secondary: `#FBBF24` (amber), Tertiary: `#0F2747` (navy blue). All brand materials now aligned.
- **v1.1**: Updated to use aubergine/magenta (`#C80064`) as secondary color
- **v1.0**: Initial style guide with blueish cyan primary color (`#00ccff`)
- Colors now aligned with `logo_new.svg` brand identity - logo features cyan blue accent, amber/yellow accent, and navy blue base
...
**Maintained by**: SysNex Systems Development Team
