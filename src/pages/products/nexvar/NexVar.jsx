...
const NexVar = () => {
  const product = getProductById('nexvar')
    ...
    <div className="page">
      ...
      <section className="page-content-section">
        <div className="container">
          <div className="section-header">
            <h2>Key Features</h2>
            <p className="section-subtitle">UVL-based variability management with constraint solving</p>
          </div>
      ...
      <section className="page-section-alt">
        <div className="container">
          <div className="section-header">
            <h2>Components</h2>
            <p className="section-subtitle">NexVar components for variability management</p>
          </div>
      ...
      <section className="page-content-section">
        <div className="container">
          <div className="section-header">
            <h2>Use Cases</h2>
            <p className="section-subtitle">How NexVar fits into your workflow</p>
          </div>
        ...
        <div className="container">
          ...
          <div style={{ textAlign: 'center', marginTop: '2rem' }}>
            <p style={{ fontSize: '1.1rem', color: 'var(--text-secondary)', marginBottom: '1.5rem' }}>
              NexVar is available as part of the <strong>{product.badge} edition</strong>.
            </p>
      ...
      <section className="page-content-section">
        <div className="container">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="cta-content">
            <h2>Ready to Try NexVar?</h2>
            <p>Manage product line variability with constraint solving</p>
