...
const SysMLWasmFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_sysmlwasm_free(ptr >>> 0, 1));
/**
...
export class SysMLWasm {
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        SysMLWasmFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_sysmlwasm_free(ptr, 0);
    }
    /**
    ...
    generate_cst(source, file_uri) {
        ...
        const ret = wasm.sysmlwasm_generate_cst(this.__wbg_ptr, ptr0, len0, ptr1, len1);
        if (ret[2]) {
     ...
     * @returns {any}
     */
    generate_hir(source, file_uri) {
        const ptr0 = passStringToWasm0(source, wasm.__wbindgen_malloc_command_export, wasm.__wbindgen_realloc_command_export);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(file_uri, wasm.__wbindgen_malloc_command_export, wasm.__wbindgen_realloc_command_export);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.sysmlwasm_generate_hir(this.__wbg_ptr, ptr0, len0, ptr1, len1);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     * @returns {any}
     */
    generate_analytics(source, file_uri) {
        const ptr0 = passStringToWasm0(source, wasm.__wbindgen_malloc_command_export, wasm.__wbindgen_realloc_command_export);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(file_uri, wasm.__wbindgen_malloc_command_export, wasm.__wbindgen_realloc_command_export);
        const len1 = WASM_VECTOR_LEN;
     ...
     * @returns {any}
     */
    generate_documentation(source, file_uri) {
        const ptr0 = passStringToWasm0(source, wasm.__wbindgen_malloc_command_export, wasm.__wbindgen_realloc_command_export);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(file_uri, wasm.__wbindgen_malloc_command_export, wasm.__wbindgen_realloc_command_export);
        const len1 = WASM_VECTOR_LEN;
     ...
     */
    constructor() {
        const ret = wasm.sysmlwasm_new();
        this.__wbg_ptr = ret >>> 0;
        SysMLWasmFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
...
if (Symbol.dispose) SysMLWasm.prototype[Symbol.dispose] = SysMLWasm.prototype.free;
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('sysml_wasm_bridge_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
